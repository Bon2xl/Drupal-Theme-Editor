...
<div class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  <div class="content"<?php print $content_attributes; ?>>
    ...
    if ($role_access == true) {
      echo "<p class='alert-box success'>Thank you for booking this room. An email will be sent confirming the details.</p>";
    } else {
      echo "<p class='alert-box success'>Room has been booked/updated.</p>";
    }
    ?>
    <div id='calendar'></div>
