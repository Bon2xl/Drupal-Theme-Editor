...
class EBSCORecord
{
    ...
    public function __construct($data = array())
    {
        ...
        $this->extra_links = $this->extra_links();
        $this->iconcover = $this->iconcover();
    ...
    {
      return isset($this->data['ExtraLinks']) ?
        $this->data['ExtraLinks'] : array();
    }

    /**
     * Get the book jacket or icon for the record.
     *
     * @return array
     */
    public function iconcover()
    {
      return isset($this->data['IconCover']) ?
        $this->data['IconCover'] : array();
    }
