...
//        }
     ...
     * @access public
     */
    public function apiSearch($search, $filters, $start = 1, $limit = 10, $sortBy = 'relevance', $amount = 'detailed', $mode = 'all', $includeFacet = 'y', $action = null) {
        $query = array();
        ...
        if (!empty($limiters)) {
          ...
          */
          // hard coding in full text limiter
          $query['limiter'][] = 'FT:y';
        }
        if (!empty($expanders)) {
