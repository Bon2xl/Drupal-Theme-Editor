...
class EBSCOResponse
{
    ...
    private function buildRecords($isJson = false)
    {
        ...
        foreach ($records as $record) {
            ...
            if ($record->FullText) {
                ...
                {
                    //This needs to be checked with result that has actual full text!
                    if($isJson) {
            ...
            if($isJson) {
                if (isset($record->FullText->CustomLinks)) {
            ...
            if (isset($record->CustomLinks)) {
              //dpm($record->CustomLinks);
              $result['ExtraLinks'] = array();
              foreach ($record->CustomLinks as $extraLink) {
                $category_e = $extraLink->Category ? (string) $extraLink->Category : '';
                if (isset($extraLink->Icon)) {
                  $icon_e = $extraLink->Icon ? (string) $extraLink->Icon : '';
                } else {
                  $icon_e = '';
                }
                $mouseOverText_e = $extraLink->MouseOverText ? (string) $extraLink->MouseOverText : '';
                $name_e = $extraLink->Name ? (string) $extraLink->Name : '';
                $text_e = $extraLink->Text ? (string) $extraLink->Text : '';
                $url_e = $extraLink->Url ? (string) $extraLink->Url : '';
                $result['ExtraLinks'][] = array(
                  'Category'      => $category_e,
                  'Icon'          => $icon_e,
                  'MouseOverText' => $mouseOverText_e,
                  'Name'          => $name_e,
                  'Text'          => $text_e,
                  'Url'           => $url_e
                );
            ...
            if (!empty($result['ImageInfo']['medium'])) {
              $bookCover = "<img src=\"".$result['ImageInfo']['medium']."\" class=\"jacket\" />";
            } elseif (!empty($result['ImageInfo']['thumb'])) {
              $bookCover = "<img src=\"".$result['ImageInfo']['thumb']."\" class=\"jacket\" />";
            } else {
              if (isset($result['PubType'])) {
                $pubTypeId = strtolower($result['PubType']);

                switch ($pubTypeId) {
                  case 'academicJournal':
                    $bookCover = "<img src=\"" . base_path() . "sites/all/themes/hfstacks/assets/img/stacks-academic-journals.png\" /> Academic Journal";
                    break;
                  case 'audio':
                    $bookCover = "<img src=\"" . base_path() . "sites/all/themes/hfstacks/assets/img/stacks-audio.png\" /> Audiobook";
                    break;
                  case 'biography':
                    $bookCover = "<img src=\"" . base_path() . "sites/all/themes/hfstacks/assets/img/stacks-biographies.png\" /> Biography";
                    break;
                  case 'book':
                    $bookCover = "<img src=\"" . base_path() . "sites/all/themes/hfstacks/assets/img/stacks-books.png\" /> Book";
                    break;
                  case 'conference':
                    $bookCover = "<img src=\"" . base_path() . "sites/all/themes/hfstacks/assets/img/stacks-conference-materials.png\" /> Conference";
                    break;
                  case 'dissertation':
                    $bookCover = "<img src=\"" . base_path() . "sites/all/themes/hfstacks/assets/img/stacks-dissertations.png\" /> Dissertation/ Thesis";
                    break;
                  case 'dissertation/ thesis':
                    $bookCover = "<img src=\"" . base_path() . "sites/all/themes/hfstacks/assets/img/stacks-dissertations.png\" />";
                    break;
                  case 'ebook':
                    $bookCover = "<img src=\"" . base_path() . "sites/all/themes/hfstacks/assets/img/stacks-ebooks.png\" /> eBook";
                    break;
                  case 'electronicResource':
                    $bookCover = "<img src=\"" . base_path() . "sites/all/themes/hfstacks/assets/img/stacks-electronic-resources.png\" /> Electronic Resource";
                    break;
                  case 'newspaperArticle':
                    $bookCover = "<img src=\"" . base_path() . "sites/all/themes/hfstacks/assets/img/stacks-news.png\" /> News";
                    break;
                  case 'news':
                    $bookCover = "<img src=\"" . base_path() . "sites/all/themes/hfstacks/assets/img/stacks-news.png\" /> News";
                    break;
                  case 'periodical':
                    $bookCover = "<img src=\"" . base_path() . "sites/all/themes/hfstacks/assets/img/stacks-reports.png\" /> Periodical";
                    break;
                  case 'primarySource':
                    $bookCover = "<img src=\"" . base_path() . "sites/all/themes/hfstacks/assets/img/stacks-reports.png\" /> Primary Source";
                    break;
                  case 'serialPeriodical':
                    $bookCover = "<img src=\"" . base_path() . "sites/all/themes/hfstacks/assets/img/stacks-reports.png\" /> Periodical";
                    break;
                  case 'unknown':
                    $bookCover = "<img src=\"" . base_path() . "sites/all/themes/hfstacks/assets/img/stacks-reports.png\" /> Unknown";
                    break;
                  case 'videoRecording':
                    $bookCover = "<img src=\"" . base_path() . "sites/all/themes/hfstacks/assets/img/stacks-videos.png\" /> Video Recording";
                    break;
                  default:
    ...
    private function toHTML($data, $group = null)
    {
        ...
        $allowed_searchlink_groups = array('au','url');
        ...
        $xml_to_html_tags = array(
            ...
            'linkTerm="'   => 'href="',
            'linkTarget="URL"' => '',
            'linkWindow="_blank"' => 'target="_blank"'
        );
