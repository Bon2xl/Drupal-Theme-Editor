...
function hfstacks_form_system_theme_settings_alter(&$form, $form_state) {
	...
	$form['stacks_fieldset']['color_palette'] = array(
			...
			'#options' => array(
					'default' => 'Seasons',
          'default_no_radius' => 'Seasons square corners',
          'midnight_moon' => 'Midnight Moon',
          'midnight_moon_no_radius' => 'Midnight Moon square corners',
          'spring_breeze' => 'Spring Breeze',
          'spring_breeze_no_radius' => 'Spring Breeze square corners',
          'cool_steel' => 'Cool Steel',
          'cool_steel_no_radius' => 'Cool Steel square corners'
			),
			...
			'#field_prefix' => '
				...
				<div class="dropdown-b">
					<ul>
						...
						<li class="default_no_radius">
							<span class="prim"></span>
							<span class="secnd"></span>
							Seasons square corners
						</li>
						<li class="midnight_moon">
							<span class="prim"></span>
							<span class="secnd"></span>
							Midnight Moon
						</li>
						<li class="midnight_moon_no_radius">
							<span class="prim"></span>
							<span class="secnd"></span>
							Midnight Moon square corners
						</li>
						<li class="spring_breeze">
							<span class="prim"></span>
							<span class="secnd"></span>
							Spring Breeze
						</li>
						<li class="spring_breeze_no_radius">
							<span class="prim"></span>
							<span class="secnd"></span>
							Spring Breeze square corners
						</li>
						<li class="cool_steel">
							<span class="prim"></span>
							<span class="secnd"></span>
						...
						<li class="cool_steel_no_radius">
							<span class="prim"></span>
							<span class="secnd"></span>
							Cool Steel square corners
						</li>
					</ul>
				</div>
			',
